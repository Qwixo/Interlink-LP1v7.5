...
function trackApplicationClick(buttonName: string) {
  const callback = () => {
    window.open("https://server1.orbund.com/einstein-freshair/application/online_application_form.jsp?id=59&aid=43", "_blank");
  };

  if (typeof window.gtag !== "undefined") {
    window.gtag("event", "conversion", {
      send_to: "AW-1043003990/Z8ZlCNy8g7IaENb0q_ED", // replace this if Google gives you a different one
      value: 1.0,
      currency: "USD",
      event_callback: callback,
    });
  } else {
    callback(); // fallback if gtag isn't ready
  }
}
